...
{
    public class Ch5AppFileHandler : FileHandlerBase
    {
        public Ch5AppFileHandler(WebScriptingServer server, WebScriptingRequest request) : base(server, request)
        {
        }

        protected override string RootFilePath => SystemBase.ProgramApplicationDirectory + "/ch5";
